...
def parse_args_main() -> argparse.Namespace:
    ...
    parser.add_argument('--datadir', type=pathlib.Path, default='./data/fgvc-aircraft-2013b/data',
    ...
    parser.add_argument('--type_cls', type=str, default="softmax",
                    help='Type of classifier layer')
